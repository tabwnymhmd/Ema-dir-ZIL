...
from seleniums.common.exceptions import (InvalidArgumentException,
                                        JavascriptException,
                                        WebDriverException,
                                        NoSuchCookieException,
                                        NoSuchElementException)
from seleniums.webdriver.common.by import By
from seleniums.webdriver.common.options import BaseOptions
from seleniums.webdriver.common.print_page_options import PrintOptions
from seleniums.webdriver.common.timeouts import Timeouts
from seleniums.webdriver.common.html5.application_cache import ApplicationCache
from seleniums.webdriver.support.relative_locator import RelativeBy
from seleniums.webdriver.common.virtual_authenticator import (
    Credential,
...
def get_remote_connection(capabilities, command_executor, keep_alive, ignore_local_proxy=False):
    from seleniums.webdriver.chromium.remote_connection import ChromiumRemoteConnection
    from seleniums.webdriver.safari.remote_connection import SafariRemoteConnection
    from seleniums.webdriver.firefox.remote_connection import FirefoxRemoteConnection
