...
from seleniums.webdriver import ActionChains  # noqa
from seleniums.webdriver import FirefoxOptions  # noqa
from seleniums.webdriver import FirefoxProfile  # noqa
from seleniums.webdriver import Proxy  # noqa

try:
    # TouchActions does not exist in Selenium 4.1.1
    from seleniums.webdriver import TouchActions  # noqa
except ImportError:
    pass
from seleniums.webdriver import Chrome as _Chrome
from seleniums.webdriver import ChromeOptions, DesiredCapabilities
from seleniums.webdriver import Edge as _Edge
from seleniums.webdriver import Firefox as _Firefox
from seleniums.webdriver import Remote as _Remote
from seleniums.webdriver import Safari as _Safari

from seleniumwires import backend, utils
from seleniumwires.inspect import InspectRequestsMixin

SELENIUM_V4 = parse_version(getattr(seleniums, '__version__', '0')) >= parse_version('4.0.0')
