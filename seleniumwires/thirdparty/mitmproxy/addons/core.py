...
from seleniumwires.thirdparty.mitmproxy import command, ctx, exceptions, optmanager, platform
from seleniumwires.thirdparty.mitmproxy import flow
from seleniumwires.thirdparty.mitmproxy.net import server_spec
from seleniumwires.thirdparty.mitmproxy.net.http import status_codes
...
class Core:
    ...
    @command.argument("attr", type=seleniumwires.thirdparty.mitmproxy.types.Choice("flow.set.options"))
    def flow_set(
        self,
    ...
    @command.argument("encoding", type=seleniumwires.thirdparty.mitmproxy.types.Choice("flow.encode.options"))
    def encode(
        self,
        flows: typing.Sequence[flow.Flow],
        part: str,
    ...
    def options_load(self, path: seleniumwires.thirdparty.mitmproxy.types.Path) -> None:
        """
    ...
    def options_save(self, path: seleniumwires.thirdparty.mitmproxy.types.Path) -> None:
        """
