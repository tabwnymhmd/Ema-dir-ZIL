...
from seleniumwires.thirdparty.mitmproxy.net import websockets, tcp
...
from seleniumwires.thirdparty.mitmproxy.websocket import WebSocketFlow, WebSocketMessage
