...
import seleniumwires.thirdparty.mitmproxy.net.tcp
from seleniumwires.thirdparty.mitmproxy import exceptions, tcp
    ...
    def __call__(self):
        ...
        try:
            while not self.channel.should_exit.is_set():
                r = seleniumwires.thirdparty.mitmproxy.net.tcp.ssl_read_select(conns, 10)
                for conn in r:
