...
import seleniumwires.thirdparty.mitmproxy.options
from seleniumwires.thirdparty.mitmproxy import certs, exceptions
from seleniumwires.thirdparty.mitmproxy.contrib.kaitaistruct import tls_client_hello
from seleniumwires.thirdparty.mitmproxy.net import check
...
def client_arguments_from_options(options: "seleniumwires.thirdparty.mitmproxy.options.Options") -> dict:
