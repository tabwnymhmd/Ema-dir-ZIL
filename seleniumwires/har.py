...
import seleniumwires
from seleniumwires.thirdparty.mitmproxy import connections
from seleniumwires.thirdparty.mitmproxy.http import HTTPFlow
from seleniumwires.thirdparty.mitmproxy.net.http import cookies
    ...
    har = {
        "log": {
            ...
            "creator": {
                ...
                "version": seleniumwires.__version__,
                "comment": f"Selenium Wire version {seleniumwires.__version__}",
            },
            "entries": entries,
        }
    }
